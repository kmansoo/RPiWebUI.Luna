...
(function () {
    ...
    ControlController.$inject = ['$rootScope', 'AuthenticationService', '$http', '$timeout', 'LunaWaitingDialog'];
    function ControlController($rootScope, AuthenticationService, $http, $timeout, LunaWaitingDialog) {
